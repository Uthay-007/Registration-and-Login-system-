...
def user_check():
    if re.fullmatch(regex, username):
        ...
        print("Invalid Email")
        print("email/username should have @ and followed by . , eg:- user@domain.com")
        register()
...
def check_pwd():
    ...
    if result:
        ...
        print("password length 5- 16 Must have minimum one special character,one digit,one uppercase and lowercase character")     
        register()
